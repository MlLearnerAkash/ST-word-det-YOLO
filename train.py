...
def main(
    base_model: str,
    datasets: str = "/home/akash/ws/ST-YOLO-word-det/ultralytics/cfg/datasets/st_dataset.yaml",
    epochs: int = 150,
    imgsz: int = 1024,
    batch: int = 1,
    dropout: float = 0.05,
    resume: bool = False,
    device = "0",
    name: str= "ST-word-det-YOLO_indic_281124_imgsz1024_",
    project = "/home/akash/ws/artifacts/ST/ST-word-det-YOLO",
    freeze: int = 0,
